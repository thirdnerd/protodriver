-- Qualified TI-84 Plus CE device/v2 module.
...
return {
  ...
  capture=function(_,io)
    ...
    -- The zero nominal 16-bit length is retained CE behavior; the validated
    -- outer virtual length bounds the framebuffer, not that nominal field.

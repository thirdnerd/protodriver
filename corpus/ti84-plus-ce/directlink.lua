-- DirectLink framing for the CE screenshot exchange, not a general calculator
-- protocol helper.
local M = {}
...
-- Entry supplies direct channel reads; the session handler supplies mailbox reads.
